...
// member functions vector::push_back and vector::pop_back instead of push and pop below.
// The tests run in main() are identical to the previous stack-resizing implementation.
